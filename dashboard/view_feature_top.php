...
$_ftop_select = "SELECT * FROM feature_top ORDER BY id ASC";
...
<div class="main_content_iner ">
    ...
    <div class="text-center mb-3">
            ...
            <h2>VIEW FEATURES TOP INFORMATION</h2>
        </div>
        <div class="row">
            <?php
                ...
                <div class="col-sm-4 mb-3 text-center">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="../controller/ftop_status.php?id=<?= $_ftop['id']?>" class="btn <?= $_ftop['status'] == 1 ? 'btn-danger' : 'btn-success' ?> text-light"><?= $_ftop['status'] == 1 ? 'Deactive' : 'Active' ?></a>
                            <a href="" class="btn btn-danger">DELETE</a>
                            <a href="./edit_ftop.php?id=<?= $_ftop['id']?>" class="btn btn-primary">EDIT</a>
                        </div>
                    </div>
                </div>
            <?php
